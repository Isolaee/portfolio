  ...
  return (
    <section id="hero" className="hero">
      <div className="container hero__inner">
        ...
        <p className="hero__role">{profile?.title ?? 'Software Engineer'}</p>
        <p className="hero__bio">{profile?.bio ?? 'I build things for the web.'}</p>
        ...
        <div className="hero__socials">
          {profile?.github && (
            <a href={profile.github} target="_blank" rel="noreferrer" className="hero__social-link">
              <GitHubIcon /> GitHub
            </a>
          )}
          {profile?.linkedin && (
            <a href={profile.linkedin} target="_blank" rel="noreferrer" className="hero__social-link">
